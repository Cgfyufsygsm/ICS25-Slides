...
![open](/07-SysIO/open.svg){.h-50.mx-auto}
...
![tree](/07-SysIO/tree.png){.h-60.mx-auto}
...
![shared_files_1](/07-SysIO/shared_files_1.png)

</div>

<div :class="$clicks==1 ? 'opacity-100' : 'opacity-0'" transition duration-200 absolute text-sm>

![shared_files_2](/07-SysIO/shared_files_2.png)

</div>

<div :class="$clicks==2 ? 'opacity-100' : 'opacity-0'" transition duration-200 absolute text-sm>

![shared_files_3](/07-SysIO/shared_files_3.png)
...
![shared_files_4](/07-SysIO/shared_files_4.png)
