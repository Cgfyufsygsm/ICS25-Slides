...
layout: cover
coverBackgroundUrl: /10-CONC/cover.jpg
---
...
![conc_based_on_processes](/10-CONC/conc_based_on_processes.png){.mx-auto.h-50}
...
![conc_based_on_processes_logic_flow](/10-CONC/conc_based_on_processes_logic_flow.png){.mx-auto.h-100}
...
![thread-stack](/10-CONC/thread-stack.png){.h-100}

</div>

<div>

![thread-concurrent](/10-CONC/thread-concurrent.png)
...
![thread-parallel](/10-CONC/thread-parallel.png){.h-60.m-auto}
