...
layout: cover
coverBackgroundUrl: /08-VM/cover.jpg
---
...
![physical_addressing](/08-VM/physical_addressing.png){.h-55.mx-auto}
...
![virtual_addressing](/08-VM/virtual_addressing.png){.h-55.mx-auto}
...
![memory_hierarchy](/08-VM/memory_hierarchy.png){.mx-auto}
...
![vm_as_cache](/08-VM/vm_as_cache.png){.mx-auto}
...
![page_table](/08-VM/page_table.png){.h-60.mx-auto}
...
![page_table](/08-VM/page_table.png){.h-70.mx-auto}
...
![review_fully_associative](/08-VM/review_fully_associative.png){.mx-auto}
...
![mem_protection](/08-VM/mem_protection.png){.h-70.mx-auto}
...
![vm_translation](/08-VM/vm_translation.png){.mx-auto}
...
![vm_translation_detail_hit](/08-VM/vm_translation_detail_hit.png){.mx-auto}
...
![vm_translation_detail_miss](/08-VM/vm_translation_detail_miss.png){.mx-auto}
...
![page_table_cache](/08-VM/page_table_cache.png){.mx-auto.h-70}
...
![tlb](/08-VM/tlb.png){.mx-auto}
![vp_tlb](/08-VM/vp_tlb.png){.mx-auto}
...
![vp_tlb](/08-VM/vp_tlb.png){.mx-auto}
![cache_address](/08-VM/cache_address.png){.mx-auto}
...
![multi_level_page_table](/08-VM/multi_level_page_table.png){.mx-auto}


</div>
<div :class="$clicks==1 ? 'opacity-100' : 'opacity-0'" transition duration-400 absolute>

![multi_level_page_table_2](/08-VM/multi_level_page_table_2.png){.mx-auto}
...
![multi_level_page_table](/08-VM/multi_level_page_table.png){.mx-auto.h-50}


![multi_level_page_table_2](/08-VM/multi_level_page_table_2.png){.mx-auto.h-50}
...
![address_translation_all](/08-VM/address_translation_all.png){.mx-auto}
...
![i7_p1_to_p3](/08-VM/i7_p1_to_p3.png){.mx-auto.h-100}

</div>
<div :class="$clicks==1 ? 'opacity-100' : 'opacity-0'" transition duration-400 absolute w-full>

![i7_p4](/08-VM/i7_p4.png){.mx-auto.h-100}
...
![linux_vm_process](/08-VM/linux_vm_process.png){.mx-auto.h-100}
...
![linux_vm_organization](/08-VM/linux_vm_organization.png){.mx-auto.h-90}
...
![page_fault](/08-VM/page_fault.png){.mx-auto.h-90}
...
![shared_object](/08-VM/shared_object.png){.mx-auto}
...
![loader](/08-VM/loader.png){.mx-auto.h-100}
...
![mmap](/08-VM/implicit_block.png){.mx-auto}
